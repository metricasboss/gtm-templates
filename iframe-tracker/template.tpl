...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Iframe Tracker for Adsense Events",
  "brand": {
    "id": "brand_dummy",
  ...
  "description": "Iframe Tracker for Adsense Events",
  "containerContexts": [
    "WEB"
  ]
}
...
injectScript("https://gtm-templates.s3.us-east-1.amazonaws.com/iframe-tracker-bundle.js", data.gtmOnSuccess, data.gtmOnFailure);
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://gtm-templates.s3.us-east-1.amazonaws.com/iframe-tracker-bundle.js"
              }
            ]
          }
        }
